...
export class NetLabelPainter extends LabelPainter {
    ...
    override create_shape(
        ...
        // FIXME AH HOC to get the bbox of net label
        pts = [new Vec2(0, 0)];
